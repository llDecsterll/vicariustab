                ...
                <div className="space-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                    <span className="font-bold text-slate-800 text-sm leading-none flex items-center gap-2">
                      {translateActivityAction(act.action, t)}
                      <span className="text-[10px] uppercase px-2 py-0.5 rounded-full bg-slate-100 text-slate-500 font-semibold font-mono">
                        {t(act.type)}
                      </span>
                    </span>
                    <span className="text-slate-400 text-xs font-mono">
                      {formatLocalizedDateTime(act.timestamp, language, t)}
                    </span>
                  </div>

                  <p className="text-slate-600 text-sm leading-relaxed">{translateActivityDetail(act.detail, t)}</p>
